<template>
  <nav class="fixed w-full p-6 bg-transparent ">
    <div class="flex items-center justify-between">
      ...
      <!-- Mobile toggle -->
      <div class="md:hidden bg-gray-500 bg-opacity-50 p-1 rounded-lg">
        <button @click="drawer">
          <svg
      ...
      <!-- Drawer Menu -->
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30 text-black" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          ...
          <li><a href="test-blogg" @click="isOpen = false" class="my-4 inline-block">Features</a></li>
        ...
        <div class="follow">
          ...
          <div class="social flex space-x-5 mt-4 ">
            ...
            <a href="https://www.instagram.com/robins_instaswe/">
              <svg
                aria-hidden="true" focusable="false"
            ...
            <a href="https://github.com/abbrobvik" class="text-gray-500 hover:text-gray-900">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
